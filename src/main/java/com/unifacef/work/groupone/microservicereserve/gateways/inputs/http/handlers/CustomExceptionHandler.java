package com.unifacef.work.groupone.microservicereserve.gateways.inputs.http.handlers;

import com.unifacef.work.groupone.microservicereserve.exceptions.BadRequestException;
import com.unifacef.work.groupone.microservicereserve.exceptions.NotFoundException;
import com.unifacef.work.groupone.microservicereserve.gateways.inputs.http.responses.ErrorResponse;
...
public class CustomExceptionHandler {
    ...
    public HttpEntity<ErrorResponse> handleThrowable(final Throwable ex) {
        ...
        return new ResponseEntity<>(createMessage(ex), responseHeaders, HttpStatus.INTERNAL_SERVER_ERROR);
    }
